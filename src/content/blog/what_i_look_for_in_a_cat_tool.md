...
![Selecting corresponding pieces of source and target text in the memoQ grid](/blog-images/dual-text-selection-in-CAT-tool-grid.png)
...
![memoQ preview pane example](/blog-images/preview.jpg)
...
![Import/export of bilingual table format into CAT tool](/blog-images/import-export-bilingual-table-CAT-tool.png)
...
![memoQ waiting for segment to get confirmed (ugh)](/blog-images/memoQ-waiting-for-segment-confirmed.jpg)
