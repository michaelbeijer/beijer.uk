...
![Selecting corresponding pieces of source and target text in the memoQ grid](./images/dual-text-selection-in-CAT-tool-grid.png)
...
![memoQ preview pane example](./images/preview.jpg)
...
![Import/export of bilingual table format into CAT tool](./images/import-export-bilingual-table-CAT-tool.png)
...
![memoQ waiting for segment to get confirmed (ugh)](./images/memoQ-waiting-for-segment-confirmed.jpg)
